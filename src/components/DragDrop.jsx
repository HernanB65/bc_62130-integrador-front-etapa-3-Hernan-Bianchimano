...
const DragDrop = ({ setFoto, setSrcImagen, srcImagen }) => {
    ...
    const handleEnter = () => {
        console.log('Una imagen ingresó en la zona de drop')
    ...
    const handleLeave = () => {
        console.log('Una imagen salió de la zona de drop')
    }
  ...
  return (
    <div className="drop-area" onDrop={handleDrop} onDragEnter={handleEnter} onDragOver={handleOver} onDragLeave={handleLeave}>
